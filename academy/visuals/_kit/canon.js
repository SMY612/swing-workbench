...
window.CANON = /*CANON-JSON*/{
  "name": "canonical_v2",
  "target_mode": "r2",
  "regime": { "spy_sma_len": 50, "adx_season_gate": 25.0, "enforce_season": false },
  "breakout": {
  ...
  "exit": {
    "time_stop_days": 21, "time_stop_min_r": 0.5, "sma_exit": false, "sma_exit_len": 50,
    "exit_mode": "fixed_r2", "atr_mult": 2.5, "psar_step": 0.02, "psar_max_af": 0.2,
    "donchian_n": 20, "time_stop_days_pullback": null
  },
